...
.controller('ResearchCtrl', ['$scope', function($scope) {
    ...
    $scope.currentProjects = [
        ...
        },
        {
            ...
            img_link: "",
            link_name: "",
            description: "Leading a team of CU Undergraduates, I am working on a platform for situatationally aware prototyping in augmented reality. We are interested in the efficacy of such tools and how prototyping in situ can increase inclusion in AR application design to domain experts, rather than just developers."
        },
        {
            img: "",
